package com.ks.demo.limiter.common.helper;
...
public class RedissonLockHelper {
    ...
    // 加锁执行业务方法，没有返回值
    public void executeWithLock(String lockKey, long waitTime, Consumer<Void> bizLogic) throws RuntimeException {
        executeWithLock(lockKey, waitTime, () -> {
            bizLogic.accept(null);
            return null;
        });
    }
}
